...
import (
	...
	specification "github.com/mehdihadeli/store-golang-microservice-sample/pkg/core/data/specification"
...
type mockConstructorTestingTNewGenericRepositoryWithDataModel interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGenericRepositoryWithDataModel[TDataModel interface{}, TEntity interface{}](t mockConstructorTestingTNewGenericRepositoryWithDataModel) *GenericRepositoryWithDataModel[TDataModel, TEntity] {
