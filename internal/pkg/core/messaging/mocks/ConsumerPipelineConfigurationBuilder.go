...
func (_m *ConsumerPipelineConfigurationBuilder) AddPipeline(_a0 pipeline2.ConsumerPipeline) pipeline2.ConsumerPipelineConfigurationBuilder {
	ret := _m.Called(_a0)

	var r0 pipeline2.ConsumerPipelineConfigurationBuilder
	if rf, ok := ret.Get(0).(func(pipeline2.ConsumerPipeline) pipeline2.ConsumerPipelineConfigurationBuilder); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(pipeline2.ConsumerPipelineConfigurationBuilder)
		}
	}
...
func (_c *ConsumerPipelineConfigurationBuilder_AddPipeline_Call) Run(run func(_a0 pipeline2.ConsumerPipeline)) *ConsumerPipelineConfigurationBuilder_AddPipeline_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(pipeline2.ConsumerPipeline))
	})
	return _c
}
...
func (_m *ConsumerPipelineConfigurationBuilder) Build() *pipeline2.ConsumerPipelineConfiguration {
	ret := _m.Called()

	var r0 *pipeline2.ConsumerPipelineConfiguration
	if rf, ok := ret.Get(0).(func() *pipeline2.ConsumerPipelineConfiguration); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pipeline2.ConsumerPipelineConfiguration)
		}
	}
...
func (_c *ConsumerPipelineConfigurationBuilder_Build_Call) Return(_a0 *pipeline2.ConsumerPipelineConfiguration) *ConsumerPipelineConfigurationBuilder_Build_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ConsumerPipelineConfigurationBuilder_Build_Call) RunAndReturn(run func() *pipeline2.ConsumerPipelineConfiguration) *ConsumerPipelineConfigurationBuilder_Build_Call {
	_c.Call.Return(run)
	return _c
}
