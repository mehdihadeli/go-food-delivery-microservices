...
func (_m *ConsumerConnector) ConnectConsumer(messageType types.IMessage, _a1 consumer2.Consumer) error {
	ret := _m.Called(messageType, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(types.IMessage, consumer2.Consumer) error); ok {
...
func (_c *ConsumerConnector_ConnectConsumer_Call) Run(run func(messageType types.IMessage, _a1 consumer2.Consumer)) *ConsumerConnector_ConnectConsumer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.IMessage), args[1].(consumer2.Consumer))
	})
	return _c
}
...
func (_c *ConsumerConnector_ConnectConsumer_Call) RunAndReturn(run func(types.IMessage, consumer2.Consumer) error) *ConsumerConnector_ConnectConsumer_Call {
	_c.Call.Return(run)
	return _c
}

// ConnectConsumerHandler provides a mock function with given fields: messageType, consumerHandler
func (_m *ConsumerConnector) ConnectConsumerHandler(messageType types.IMessage, consumerHandler consumer2.ConsumerHandler) error {
	ret := _m.Called(messageType, consumerHandler)

	var r0 error
	if rf, ok := ret.Get(0).(func(types.IMessage, consumer2.ConsumerHandler) error); ok {
...
func (_c *ConsumerConnector_ConnectConsumerHandler_Call) Run(run func(messageType types.IMessage, consumerHandler consumer2.ConsumerHandler)) *ConsumerConnector_ConnectConsumerHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.IMessage), args[1].(consumer2.ConsumerHandler))
	})
	return _c
}
...
func (_c *ConsumerConnector_ConnectConsumerHandler_Call) RunAndReturn(run func(types.IMessage, consumer2.ConsumerHandler) error) *ConsumerConnector_ConnectConsumerHandler_Call {
	_c.Call.Return(run)
	return _c
}
