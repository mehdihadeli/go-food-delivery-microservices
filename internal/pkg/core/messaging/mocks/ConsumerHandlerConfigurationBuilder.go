...
func (_m *ConsumerHandlerConfigurationBuilder) AddHandler(handler consumer2.ConsumerHandler) consumer2.ConsumerHandlerConfigurationBuilder {
	ret := _m.Called(handler)

	var r0 consumer2.ConsumerHandlerConfigurationBuilder
	if rf, ok := ret.Get(0).(func(consumer2.ConsumerHandler) consumer2.ConsumerHandlerConfigurationBuilder); ok {
		r0 = rf(handler)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(consumer2.ConsumerHandlerConfigurationBuilder)
		}
	}
...
func (_c *ConsumerHandlerConfigurationBuilder_AddHandler_Call) Run(run func(handler consumer2.ConsumerHandler)) *ConsumerHandlerConfigurationBuilder_AddHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(consumer2.ConsumerHandler))
	})
	return _c
}

func (_c *ConsumerHandlerConfigurationBuilder_AddHandler_Call) Return(_a0 consumer2.ConsumerHandlerConfigurationBuilder) *ConsumerHandlerConfigurationBuilder_AddHandler_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ConsumerHandlerConfigurationBuilder_AddHandler_Call) RunAndReturn(run func(consumer2.ConsumerHandler) consumer2.ConsumerHandlerConfigurationBuilder) *ConsumerHandlerConfigurationBuilder_AddHandler_Call {
	_c.Call.Return(run)
	return _c
}

// Build provides a mock function with given fields:
func (_m *ConsumerHandlerConfigurationBuilder) Build() *consumer2.ConsumerHandlersConfiguration {
	ret := _m.Called()

	var r0 *consumer2.ConsumerHandlersConfiguration
	if rf, ok := ret.Get(0).(func() *consumer2.ConsumerHandlersConfiguration); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*consumer2.ConsumerHandlersConfiguration)
		}
	}
