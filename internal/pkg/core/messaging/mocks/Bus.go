...
func (_m *Bus) ConnectConsumer(messageType types.IMessage, _a1 consumer2.Consumer) error {
...
func (_c *Bus_ConnectConsumer_Call) Run(run func(messageType types.IMessage, _a1 consumer2.Consumer)) *Bus_ConnectConsumer_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *Bus) ConnectConsumerHandler(messageType types.IMessage, consumerHandler consumer2.ConsumerHandler) error {
...
func (_c *Bus_ConnectConsumerHandler_Call) Run(run func(messageType types.IMessage, consumerHandler consumer2.ConsumerHandler)) *Bus_ConnectConsumerHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Bus_ConnectConsumerHandler_Call) RunAndReturn(run func(types.IMessage, consumer2.ConsumerHandler) error) *Bus_ConnectConsumerHandler_Call {
	_c.Call.Return(run)
	return _c
}
