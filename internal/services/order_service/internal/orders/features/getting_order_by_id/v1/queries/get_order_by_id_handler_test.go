...
func Test_Get_Order_By_Id_Query_Handler(t *testing.T) {
	...
	err := mediatr.RegisterRequestHandler[*GetOrderById, *dtos.GetOrderByIdResponseDto](
		NewGetOrderByIdHandler(fixture.Log, fixture.Cfg, fixture.MongoOrderReadRepository),
	)
	if err != nil {
		return
	}
	...
	queryResult, err := mediatr.Send[*GetOrderById, *dtos.GetOrderByIdResponseDto](
		context.Background(),
		query,
	)
