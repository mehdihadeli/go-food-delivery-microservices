...
// 	protoc        v4.23.4
// source: catalog_write_service/products.proto
...
var file_catalog_write_service_products_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_catalog_write_service_products_proto_goTypes = []interface{}{
