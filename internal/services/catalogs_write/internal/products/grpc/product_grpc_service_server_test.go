...
import (
	...
	productService "github.com/mehdihadeli/go-ecommerce-microservices/internal/services/catalogs/write_service/internal/products/grpc/proto/service_clients"
	"github.com/mehdihadeli/go-ecommerce-microservices/internal/services/catalogs/write_service/internal/products/mocks"
...
type productGrpcServiceE2eTests struct {
	...
	*e2e.E2ETestSharedFixture
	productsServiceClient mocks.ProductsServiceClient
}
...
func (c *productGrpcServiceE2eTests) Test_Should_Return_Data_With_Valid_Id() {
	...
	res, err := c.productsServiceClient.GetProductById(
		c.Ctx,
