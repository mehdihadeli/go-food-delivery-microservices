...
type Config struct {
	...
	Logger            *logger.LogOptions             `mapstructure:"logger"                              envPrefix:"Logger_"`
	GRPC              *grpc.GrpcOptions              `mapstructure:"grpc"                                envPrefix:"GRPC_"`
	Http              *customEcho.EchoHttpOptions    `mapstructure:"http"                                envPrefix:"Http_"`
	...
	GormPostgres      *gormPostgres.GormOptions      `mapstructure:"gormPostgres"                        envPrefix:"GormPostgres_"`
