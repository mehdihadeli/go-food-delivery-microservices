...
import (
	...
	mongoTestContainer "github.com/mehdihadeli/store-golang-microservice-sample/pkg/test/containers/testcontainer/mongo"
	"github.com/mehdihadeli/store-golang-microservice-sample/services/catalogs/read_service/config"
	"github.com/mehdihadeli/store-golang-microservice-sample/services/catalogs/read_service/internal/products/mocks/testData"
...
func seedMongoAndMigration(db *mongo.Client) error {
	...
	collection := db.Database("catalogs").Collection("products")
