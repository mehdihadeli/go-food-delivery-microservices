...
func NewMongoOrderProjection(mongoOrderRepository repositories.OrderReadRepository, rabbitmqProducer producer.Producer) projection.IProjection {
	return &mongoOrderProjection{mongoOrderRepository: mongoOrderRepository, rabbitmqProducer: rabbitmqProducer}
}
